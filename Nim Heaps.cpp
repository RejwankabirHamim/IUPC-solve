//https://algo.codemarshal.org/contests/aust-2022/problems/D
#include<bits/stdc++.h>
...
ll int a[1000005],b[1000005],c[1000005],d[1000005],e[1000005];
...
int main()
{
    ...
    b[1000002]=mod_inverse(b[1000002],M-2),e[1000002]=mod_inverse(d[1000002],M-2);
    rfr(i,1000001,0)b[i]=(b[i+1]*(i+1))%M,e[i]=(e[i+1]*(a[i+1]-1+M))%M;
    scanf("%lld",&te);
    //cin>>te;
    fr(w,te,1)
    {
